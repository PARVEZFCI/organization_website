            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    ...
                    <div class="about-title-section about-title-section-2 mb-30">
                        <h1>Who We Are</h1>
                        {!! $aboutSetting && $aboutSetting->who_we_are ? $aboutSetting->who_we_are : '<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>' !!}
                    </div>
                </div>
                <div class="col-xl-5 col-lg-5">
                    ...
                    <div class="about-title-section about-title-section-2 mb-30">
                        ...
                        {!! $aboutSetting && $aboutSetting->mission_vission ? $aboutSetting->mission_vission : '<p>Sed ut perspiciatis unde omnis iste natus error sit voluptat accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
