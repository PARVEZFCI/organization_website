            ...
            <div class="row">
                <div class="col-lg-8 col-md-10">
                    <div class="hero-content">
                        ...
                        <button class="btn btn-outline-custom">Donate Now</button>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
        <div class="search-section">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-lg-3 col-md-6">
                    <label class="form-label fw-bold">Donation Amount <sup style="color: red;">*</sup></label>
                    <input type="number" class="form-control" placeholder="৳ Write in number">
                </div>
                <div class="col-lg-3 col-md-6">
                    <button class="btn btn-primary-custom w-100" style="padding: 13px 30px;">Donate</button>
                </div>
            </div>
            <p class="text-center mt-4 mb-0" style="color: #333; font-size: 0.95rem;">
                You will receive tax relief when you donate to Dream Youth Club.
